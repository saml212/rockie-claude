...
# scan the project CLAUDE.md for a matching `## Stage: <name>` section
# and inject its body via stderr. Agent sees stage-specific context
...
# CLAUDE.md lives at the project repo root: <repo>/<CLAUDE.md>
